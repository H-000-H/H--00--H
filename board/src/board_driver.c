 ...
 * @param[in] pin GPIO 引脚编号
 * @param[in] safe_level 安全态电平 (0/1)
 */
 ...
 * @param[in] pdev probe 失败的 device 指针
 * @param[in] id 设备 ID (未使用, 保留供扩展)
 */
 ...
 * @param[in] failed_id probe 失败的设备 ID
 */
 ...
 * @param[in] reason 停机原因字符串 (可为 NULL)
 */
